...
<body class="loaded revealed">
	...
	<nav id="globalheader" class="servicios globalheader-js svg globalheader-loaded globalheader-loaded">
	...
	<div class="productbrowser content pb-dynamic pb-opened" id="pb-mac">
		<div class="pb-slider">		
			<div id="carousel" class="menu">
				<!-- <ul id="menu"> -->
				<div>
					<a href="#!/page" onclick = "poner_titulo(<?php echo "'Gigantografías'"; ?>)"><img src="img/servicios/GigantoGrafias.png" alt="GigantoGrafias" width="200" height="200" /></a>
					<span></span>
				</div>
				<div>
					<a href="#!/DisenioGrafico" onclick = "poner_titulo(<?php echo "'Diseo gráfico'"; ?>)"><img src="img/servicios/DisenioGrafico.png" alt="DisenioGrafico" width="200" height="200" /></a>
					<span></span>
				</div>
				<div>
					<a href="#!/Impresiones" onclick = "poner_titulo(<?php echo "'Impresiones'"; ?>)"><img src="img/servicios/Impresiones.png" alt="Impresiones" width="200" height="200" /></a>
					<span></span>
				</div>
				<div>
					<a href="#!/Tarjetas" onclick = "poner_titulo(<?php echo "'Tarjetas'"; ?>)"><img src="img/servicios/Tarjetas.png" alt="Tarjetas" width="200" height="200" /></a>
					<span></span>
				</div>
				<div>
					<a href="#!/RetoqueFotografico" onclick = "poner_titulo(<?php echo "'Retoques fotográficos'"; ?>)"><img src="img/servicios/RetoqueFotografico.png" alt="RetoqueFotografico" width="200" height="200" /></a>
					<span></span>
				</div>
				<!-- </ul> -->
			</div>		
		...
		<div class="pb-pageindicator roundedbottom page-1" id="pb-pi-mac">
			<div style="font-size:15px; font-style: italic; color:#adadaf;">
				<b class="caret"></b>
				<a page="1" id="titulo_seccion" class="page active" >Gigantografías</a>
			</div>
		</div>
	</div>
			...
			<ul>
	            ...
	            <li id="Tarjetas">
	            	<center>
		            	...
		            	<div  class="grid2col" id="whymac">
							<section class="column first content">
								<p style="padding-left:1em;">Es un grato recibir a nuestros clientes en nuestro local, 	se puede sentir como en su casa. <br>
								Por ello hacemos lo posible que el ambiente en donde estamos ubicados sea de agrado para nuestros clientes y vicitantes.</p>
								<img class="bottom" src="https://encrypted-tbn2.gstatic.com/images?q=tbn:ANd9GcRYZOgzlEWJIVQf4Ebs1bBwNELeKWoCvSUIMGyBqhapYTUlM_wolA" width="143" height="249" alt="">
							</section>
